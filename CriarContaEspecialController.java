...
public class CriarContaEspecialController implements Initializable {
	...
	private void btnSalvarAction(ActionEvent event) {
		...
		if (cboClientes.getSelectionModel().getSelectedItem() == null) {
			...
			ContaEspecial contaSimples = new ContaEspecial(cboClientes.getSelectionModel().getSelectedItem(), "0000",
					txtNumConta.getText(), 0, Double.parseDouble(txtLimite.getText()));
