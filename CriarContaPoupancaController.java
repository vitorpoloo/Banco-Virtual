...
public class CriarContaPoupancaController implements Initializable {
	...
	private void btnSalvarAction(ActionEvent event) {
		...
		if (cboClientes.getSelectionModel().getSelectedItem() == null) {
			...
			ContaSimples contaSimples = new ContaSimples(cboClientes.getSelectionModel().getSelectedItem(), "0000",
